...
bool load_content() {
  ...
  // Positions
  vector<vec3> positions{ vec3(-1.0, 1.0, 0.0), vec3(-1.0, -1.0, 0.0), vec3(1.0, -1.0, 0.0),
  ...
  eff.add_shader("28_Texturing_Shader/simple_texture.vert", GL_VERTEX_SHADER);
  eff.add_shader("28_Texturing_Shader/simple_texture.frag", GL_FRAGMENT_SHADER);
  ...
  texNoMaps = texture("textures/sign.jpg", false, false);
  // *********************************
